...
function getNutrientStatus(value, range) {
...
function getStatusColor(status) {
  switch (status) {
    case 'low': return 'text-blue-700 bg-blue-100 dark:text-blue-300 dark:bg-blue-700/30 border border-blue-200 dark:border-blue-600';
    case 'high': return 'text-red-700 bg-red-100 dark:text-red-300 dark:bg-red-700/30 border border-red-200 dark:border-red-600';
    case 'optimal': return 'text-green-700 bg-green-100 dark:text-green-300 dark:bg-green-700/30 border border-green-200 dark:border-green-600';
    case 'moderate': return 'text-yellow-700 bg-yellow-100 dark:text-yellow-300 dark:bg-yellow-600/30 border border-yellow-200 dark:border-yellow-500';
    default: return 'text-slate-600 bg-slate-100 dark:text-slate-400 dark:bg-slate-700/50 border border-slate-200 dark:border-slate-600';
  }
}

const DetailsTab = ({ results }) => (
